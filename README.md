...
譬如一個短期活動，如果使用原生 Native 的開發方式，與純網頁相較，在成本和時間上並沒有多大的優勢。可是好不容易「導流」使用者使用App，若是又讓使用者跳出我們設計的使用情境，去使用瀏覽器
在許多的調查都告訴我們，一段時間內，使用者不會再回來我們所設計的App所以如果需要使用網頁內容時，還是會希望將使用情境置於我們開發的 App 中
